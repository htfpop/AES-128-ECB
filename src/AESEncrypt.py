...
def test_enc():
    ...
    print()
"""
    print(f'[DECRYPT] round{10}: istart')
    tools.debug_print_arr_2dhex_1line(state)
    print()

    print(f'[DECRYPT] round{10}: is_row')
    shift_rows_inv(state)
    tools.debug_print_arr_2dhex_1line(state)
    print()

    print(f'[DECRYPT] round{10}: is_box')
    s_box_inv_sub(state)
    tools.debug_print_arr_2dhex_1line(state)
    print()
    ...
    print(f'[DECRYPT] round{10}: ik_sch')
    tools.debug_print_arr_2dhex_1line(round_key)
    print()

    print(f'[DECRYPT] round{10}: ik_add')
    state = tools.xor_2d(state, round_key)
    tools.debug_print_arr_2dhex_1line(state)
    print()
"""
